...
export function Card({
  ...
  return (
    <div
      className={cn(
        'bg-white rounded-xl border border-slate-200/80 shadow-xs hover:shadow-sm transition-shadow',
        className
      )}
      {...props}
    >
...
export function CardFooter({
  ...
  return (
    <div
      className={cn('p-6 pt-0 border-t border-slate-100 mt-4 flex items-center', className)}
      {...props}
    >
      {children}
    </div>
